...
with tab2:
    ...
    unique_colleges = filtered_year_df['School'].astype(str).unique()
    # Convert unique colleges to a Python list and sort them
    ...
    unique_departments = filtered_college_df['Department'].astype(str).unique()
    # Convert unique departments to a Python list and sort them
